...
local function requestKey()
    ...
    frame.BackgroundColor3 = Color3.fromRGB(30, 30, 35) -- Gris très sombre
    frame.BorderSizePixel = 0
    Instance.new("UICorner", frame).CornerRadius = UDim.new(0, 8)
    
    -- Ombre légère (facultatif, via un autre frame)
    ...
    input.Position = UDim2.new(0.5, -150, 0, 80)
    ...
    -- Bouton moderne (Bleu pro)
    local btn = Instance.new("TextButton", frame)
    btn.Size = UDim2.new(0, 300, 0, 45)
    btn.Position = UDim2.new(0.5, -150, 0, 145)
    btn.BackgroundColor3 = Color3.fromRGB(0, 122, 255) -- Bleu Apple/Pro
    btn.Text = "Verify Key"
