...
local function requestKey()
    ...
    -- Cadre principal réduit (hauteur 280 au lieu de 360)
    ...
    licenseLabel.Position = UDim2.new(0, 0, 0, 45)
    ...
    input.Position = UDim2.new(0.5, -150, 0, 75)
    ...
    line.Position = UDim2.new(0.5, -150, 0, 190)
    line.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    line.BorderSizePixel = 0
    line.BackgroundTransparency = 0.5

    -- Status (Plus gros et plus visible)
    local status = Instance.new("TextLabel", frame)
    status.Size = UDim2.new(0, 300, 0, 50) -- Plus de hauteur
    status.Position = UDim2.new(0.5, -150, 0, 205) -- Ajusté
    status.Text = "Status: Waiting..."
    status.Font = Enum.Font.GothamBold -- Police en gras
    status.TextSize = 18 -- Taille augmentée
