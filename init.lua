...
local function requestKey()
    ...
    input.Position = UDim2.new(0, 20, 0, 30)
    ...
    btn.MouseEnter:Connect(function()
        TweenService:Create(btn, TweenInfo.new(0.2), {Size = UDim2.new(0, 290, 0, 50), Position = UDim2.new(0, 15, 0, 97)}):Play()
    end)
    btn.MouseLeave:Connect(function()
        TweenService:Create(btn, TweenInfo.new(0.2), {Size = UDim2.new(0, 280, 0, 45), Position = UDim2.new(0, 20, 0, 100)}):Play()
    end)
    ...
    btn.MouseButton1Click:Connect(function()
        ...
        task.spawn(function()
            ...
            if not valid then
                ...
                for i = 1, 3 do
                    frame.Position = startPos + UDim2.new(0, 10, 0, 0)
                    task.wait(0.05)
                    frame.Position = startPos - UDim2.new(0, 10, 0, 0)
                    task.wait(0.05)
                end
                ...
                btn.Text = "VALIDATE"
                btn.Active = true
                TweenService:Create(btn, TweenInfo.new(0.3), {BackgroundColor3 = Color3.fromRGB(70, 130, 255)}):Play()
            else
