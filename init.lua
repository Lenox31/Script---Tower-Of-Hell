...
local function requestKey()
    ...
    btn.MouseButton1Click:Connect(function()
        -- 1. On change le texte pour montrer que ça travaille
        btn.Text = "Checking..."
        btn.Active = false -- Désactive le bouton pour éviter les double clics
        ...
        if valid then
            ...
            -- Le kick est exécuté immédiatement après la réponse du serveur
