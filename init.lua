...
local function isKeyValid(userKey)
    -- On utilise la fonction 'request' globale qui n'est pas bridée par Roblox
    ...
    -- Le format de retour de 'request' est similaire à RequestAsync
    ...
    if res.StatusCode == 200 then
        ...
        warn("Le serveur a répondu avec le code : " .. res.StatusCode)
        return false
    end
end
